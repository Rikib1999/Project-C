...
public class WeaponSwitching : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var button = GameObject.FindGameObjectWithTag("NextWeaponButton").GetComponent<Button>();
        if (button == null) { return; }
        button.onClick.RemoveAllListeners();
        button.onClick.AddListener(SelectNextAndroid);

        var button2 = GameObject.FindGameObjectWithTag("PreviousWeaponButton").GetComponent<Button>();
        if (button2 == null) { return; }
        button2.onClick.RemoveAllListeners();
        button2.onClick.AddListener(SelectPreviousAndroid);
    }

    public void SelectNextAndroid()
    {
    ...
    public void SelectPreviousAndroid()
    {
        int previousSelectedWeapon = selectedWeapon;
